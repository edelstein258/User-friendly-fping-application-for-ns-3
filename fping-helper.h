...
public:
   ...
   */
  ApplicationContainer Install (NodeContainer nodes ,Ipv4InterfaceContainer addresses)) const;
...
private:
   ...
   */
  Ptr<Application> InstallPriv (Ptr<Node> node , Ipv4InterfaceContainer addresses)) const;
  /// Object factory
